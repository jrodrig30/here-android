...
public class EventListFragment extends ListFragment {
    ...
    public void refresh() {
        ...
        if(mSearchText == null || "".equals(mSearchText)) {
            ...
            list = eventService.select(mSearchText);
        }

        if (list.isEmpty()) {
            Toast.makeText(getActivity(), R.string.toast_no_events, Toast.LENGTH_LONG).show();
        }
    ...
    public void onListItemClick(ListView listView, View view, int position, long id) {
        ...
        Event item = ((ArrayAdapter<Event>) getListAdapter()).getItem(position);
